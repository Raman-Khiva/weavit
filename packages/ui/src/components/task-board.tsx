  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-2">
        <h4 className="min-w-0 flex-1 text-sm leading-tight font-medium wrap-break-word">
          {task.title}
        </h4>
        <DropdownMenu>
        ...
        {task.assignees && task.assignees.length > 0 && (
          <div className="flex -space-x-1.5">
            ...
            {task.assignees.length > 3 && (
              <div className="flex size-5 items-center justify-center rounded-full border-2 border-background bg-muted text-xs text-muted-foreground">
                +{task.assignees.length - 3}
              </div>
            )}
          </div>
