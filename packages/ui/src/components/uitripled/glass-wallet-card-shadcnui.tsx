...
export function GlassWalletCard({
  ...
  return (
    ...
    >
      <Card className="group relative h-56 overflow-hidden rounded-2xl border border-border/50 bg-background backdrop-blur-md transition-all duration-300 hover:border-primary/50 hover:shadow-xl hover:shadow-primary/10">
